...
////////        // Re-enable the zone so it accepts a new drop
...
//////            if (zone.HasUnit)
//////            {
//////                // Zone is occupied — never interactive, EmptySlotZone always hidden
//////                zone.SetInteractable(false);
//////                zone._emptySlotZone?.SetActive(false);
//////            }
//////            else
//////            {
//////                // Zone is empty — interactive and EmptySlotZone visible only in Cannon scene
//////                zone.SetInteractable(visible);
//////                zone._emptySlotZone?.SetActive(visible);
//////            }
//////        }
//////    }
...
//////        _emptySlotZone.SetActive(!HasUnit && inCannonScene);
//////    }
...
////        // EmptySlotZone must NEVER be visible in Village or Castle/Expand panels —
////        // only SetCannonZonesVisible(true) may reveal it, and only when the zone is empty.
...
//        if (HasUnit)
//        {
//            // Cannon is here — never show EmptySlotZone, never interactive.
//            _emptySlotZone?.SetActive(false);
//            SetInteractable(false);
//        }
//        else
//        {
//            // Empty zone — show/hide based on whether Cannon tab is open.
