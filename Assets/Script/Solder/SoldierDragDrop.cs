...
//////        // Keep the soldier's own canvas visible so its SpriteLayerAnimator can show
//////        // the HorseIdle / HorseRun sitting pose directly on the horse.
//////        // (HideOwnVisuals would hand off rendering to HorseRiderVisual, which
//////        //  requires EquipmentItem horse-sprite arrays to be populated. Keeping
//////        //  ShowOwnVisuals here works without any extra EquipmentItem setup.)
//////        ShowOwnVisuals();
...
////        // DO NOT call HideOwnVisuals() or SetState() here.
////        // HorseController.PerformMount() calls them AFTER ShowRider(),
////        // so the hide runs last and overrides anything the animator does.
