...
//        // When leaving the Cannon section, make sure zones are hidden.
//        if (newState != GameState.Cannon)
//            CastleUnitDropZone.SetCannonZonesVisible(false);
...
////    [Header("Castle Building")]
////    [Tooltip("World-space GameObject that has CastleGrid.cs attached.")]
////    [SerializeField] private GameObject castleGridRoot;
...
////        // Cancel block placement if the player backs out of the castle panel
////        if (CurrentState == GameState.Castle && CastleGrid.Instance != null && CastleGrid.Instance.IsPlacingBlock)
////            CastleGrid.Instance.CancelPlacement();
...
////        // Show/hide the world-space castle grid alongside the castle panel
////        if (castleGridRoot != null) castleGridRoot.SetActive(newState == GameState.Castle);
