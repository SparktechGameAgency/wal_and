...
//    {
//        // Stop all cannon fire animations before the panel covers the screen.
//        // This prevents _isFiring from staying true when coroutines are interrupted.
//        CannonAutoShooter.PauseAll();
//    }

//    private void OnDisable()
//    {
//        // Re-wire animators and reset cooldowns now that the panel is closed.
//        CannonAutoShooter.ResumeAll();
//    }
...
//        // Always consume PendingDropZone here — it is set by CastleUnitDropZone.OnPointerClick
//        // just before GameManager calls this method.  This works whether callingSlot is null
//        // (zone click path) or non-null (legacy CannonSlot AddButton path).
//        if (PendingDropZone != null)
//        {
//            _callingDropZone = PendingDropZone;
//            PendingDropZone = null;
//            // Zone click — clear any legacy slot reference.
//            _callingSlot = null;
//        }
//        else
//        {
...
//            // Return to castle panel so the player can tap the next cannon zone.
//            // The cannon zones will become visible again when the player opens the
//            // cannon panel via the next zone tap.
...
public class CannonPanelManager : MonoBehaviour
{
    ...
    private void OnBuyClicked()
    {
        ...
        if (_callingDropZone != null && !_callingDropZone.HasUnit)
        {
            ...
            // cannon panel via the next zone tap.
            if (GameManager.Instance != null)
                GameManager.Instance.ReturnToCannonZones();
            else
                gameObject.SetActive(false);
        }
        else
