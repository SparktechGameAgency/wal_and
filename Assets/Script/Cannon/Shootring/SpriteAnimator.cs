...
public class SpriteAnimator : MonoBehaviour
{
    ...
    public void Stop()
    {
        ...
        // Always fire onComplete so any _isFiring flag is unlocked,
        // even when the animation is interrupted mid-play.
        onComplete?.Invoke();
        onComplete = null;   // clear to avoid double-fire when Animate() also ends
    }
