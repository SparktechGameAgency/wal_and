...
///
/// ════════════════════════════════════════════════════════════════════
///  LOCK / UNLOCK (blocksRaycasts ownership)
/// ════════════════════════════════════════════════════════════════════
///
///  This seat does NOT touch the soldier's CanvasGroup.blocksRaycasts.
///  That is managed entirely by SoldierDragDrop.SetLocked():
///
///    Unlocked (default after mount):
///      blocksRaycasts = true  → soldier intercepts clicks → draggable off the dragon
///
///    Locked (after Attach is clicked):
///      blocksRaycasts = false → clicks pass through to dragon → dragon is draggable
///
///  DragonController.OnBeginDrag blocks dragon drag when a rider is present
///  but not yet locked, preventing accidental dragon moves.
///
/// ════════════════════════════════════════════════════════════════════
///  INSPECTOR
/// ════════════════════════════════════════════════════════════════════
